...
<body>
    ...
    <div style="width: 1000px;height: 200px;margin: auto;">
        <div style="height: 30px;background-color: rgb(100,100,100);color: white;">
            <h3 > Hồ sơ xin việc của tôi</h3>
        </div>
        
            <div style="height: 50px;">
                <button  class="text-right" type="button" >
                    <a style="text-decoration: none;color: black;" href="hoso.php">Tạo hồ sơ xin việc mới</a>
                </button> 
        </div>
        <div  style="height: 50px";>      
            <button  class="text-right" type="button" >
                <a style="text-decoration: none;color: black; "href="Xemhoso.php">Xem hồ sơ</a>
            </button>
        </div>
    </div>
